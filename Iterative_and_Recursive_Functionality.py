...
def main():
    ...
    print("0! =", factorial_interative(0))
    print("5! =", factorial_interative(5))
    print("10! =", factorial_interative(10))
    print("25! =", factorial_interative(25))
    print("50! =", factorial_interative(50))
    print("100! =", factorial_interative(100))
